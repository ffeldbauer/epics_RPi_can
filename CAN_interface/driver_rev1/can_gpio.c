...
static const u32 gpioMaskM = (  1 << 21 );
static const u32 gpioMaskH = ( 15 << 22 );
static const u32 gpioMask  = (  7 <<  7 ) | ( 15 << 22 ) | (  1 << 21 );
...
static const u32 gpioFSEL2_InpMask = ~( ( 7 << 6 ) | ( 7 << 9 ) | ( 7 << 12 ) | ( 7 << 15 ) | ( 7 << 3 ) );
static const u32 gpioFSEL2_OutMask = ( 1 << 6 ) | ( 1 << 9 ) | ( 1 << 12 ) | ( 1 << 15 ) | ( 1 << 3 );
